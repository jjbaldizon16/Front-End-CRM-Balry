              ...
              <form action="registro.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="apellidos" class="form-control" id="exampleInputPassword1" placeholder="Ingrese los apellidos">
                  </div>
				  <div class="form-group">
                  ...
                  <option selected>Seleccione el nivel de usuario</option>
