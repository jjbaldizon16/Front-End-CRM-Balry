    ...
    <!-- Formulario crear cliente -->
		   ...
		   <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar Cambio de filtro</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
				  <div class="col-sm-6">
                      <div class="form-group">
                        <label for="direccion_instalacion"> Direccion Instalacion </label>
                        <textarea class="form-control" name="direccion_instalacion" rows="3"><?=$cambiofiltro['direccion_instalacion']?></textarea>
                      </div>
                    </div>
					<div class="col-sm-6">
                      <div class="form-group">
                        <label for="historial"> Historial </label>
                        <textarea class="form-control" name="historial" rows="3"><?=$cambiofiltro['historial']?></textarea>
                      </div>
                    </div>
					<div class="col-sm-6">
                      <div class="form-group">
