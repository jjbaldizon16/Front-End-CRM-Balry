        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="crear-categoria.php" class="small-box-footer">Ingresar cliente <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="crear-entradas.php" class="small-box-footer">Ingresar cambio de filtros <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="lista-clientes.php" class="small-box-footer">Ver lista de clientes <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h4>Lista de cambios de filtros</h4>
              ...
              <a href="entradas.php" class="small-box-footer">Ver lista de cambios de filtros <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
		    <!-- ./col -->
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h4>Reporte de cambios de filtros</h4>
          ...
          <!-- ./col -->
		   <!-- ./col -->
            ...
            <div class="small-box bg-danger">
              ...
              <a href="cerrar.php" class="small-box-footer">Clic aqui para cerrar sesion <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
...
<!-- ./wrapper -->
   ...
   <?php
     ...
     echo "Ingreso al sistema como vendedor";
     endif;
    ?>
