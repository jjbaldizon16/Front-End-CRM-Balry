              ...
              <form action="guardar-cliente.php?editar=<?=$cambiocliente['id']?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" name="cedula" class="form-control" id="exampleInputEmail1" value="<?=$cambiocliente['cedula']?>">
                  </div>
                  <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['nombre']?>">
                  </div>
				  <div class="form-group">
                    <label for="apellido1">Apellido1</label>
                    <input type="text" name="apellido1" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['apellido1']?>">
                  </div>
				  <div class="form-group">
                    <label for="apellido2">Apellido2</label>
                    <input type="text" name="apellido2" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['apellido2']?>">
                  </div>
				  <div class="form-group">
                    <label for="email">Correo Electronico</label>
                    <input type="email" name="email" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['email']?>">
                  </div>
				  <div class="form-group">
                    <label for="telefono1">Telefono1</label>
                    <input type="number" name="telefono1" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['telefono1']?>">
                  </div>
				  <div class="form-group">
                    <label for="telefono2">Telefono2</label>
                    <input type="number" name="telefono2" class="form-control" id="exampleInputPassword1" value="<?=$cambiocliente['telefono2']?>">
                  </div>
				  <div class="col-sm-6">
                      <div class="form-group">
                        <label> Direccion Casa </label>
                        <textarea class="form-control" name="direccion_casa" rows="3"><?=$cambiocliente['direccion_casa']?></textarea>
                      </div>
                    </div>
					<div class="col-sm-6">
                      <div class="form-group">
                        <label> Direccion Trabajo </label>
                        <textarea class="form-control" name="direccion_trabajo" rows="3" ><?=$cambiocliente['direccion_trabajo']?></textarea>
                      </div>
                    </div>
