...
<div id="principal">
  ...
  <div class="content-wrapper">
    ...
    <!-- Formulario crear cliente -->
		   ...
		   <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ingresar Cambio de Filtros</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
	...
	>
				  ...
				  <div class="col-sm-6">
                      <div class="form-group">
                        <label> Direccion Instalacion </label>
                        <textarea class="form-control" name="direccion_instalacion" rows="3" placeholder="Ingrese la direccion de la instalacion ..."></textarea>
                      </div>
                    </div>
					<div class="col-sm-6">
                      <div class="form-group">
                        <label> Historial </label>
                        <textarea class="form-control" name="historial" rows="3" placeholder="Ingrese el historial..."></textarea>
                      </div>
                    </div>
					<div class="col-sm-6">
                      <div class="form-group">
